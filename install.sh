...
check_package "pycryptodomex" "pip install https://github.com/termux-user-repository/pypi-wheel-builder/releases/download/wheels/pycryptodomex-3.20.0-cp311-cp311-linux_${arch}.whl"
