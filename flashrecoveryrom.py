...
if rom_files:
    input("Make sure your device is connected in sideloader mode. Connect your device using OTG, then press Enter when ready.")
    os.system("adb sideloader flash {}/{}".format(ROM_FOLDER, rom_files[0]))
else:
